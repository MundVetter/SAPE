...
def optimize(func: Function, encoding_type: EncodingType, model_params,
             controller_type: ControllerType, control_params: encoding_controller.ControlParams,
...
def main() -> int:
    ...
    func = Function(psine)
    num_samples = 25
    control_params = encoding_controller.ControlParams(num_iterations=4000, epsilon=1e-5, res=num_samples//2)
    ...
    control_params_2 = encoding_controller.ControlParams(num_iterations=1, epsilon=1e-5, res=num_samples//2)
